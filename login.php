    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
			...
			<li class="menu-active"><a href="#intro">Login Page</a></li>
		 </ul>
      </nav>
    </div>
			<div class="login-box">
        ...
        <form action="#" method="POST">
			...
			<u><a href="forgetpass.php"> Have you forgotten your password</u> ? </a>
...
if(isset($_POST['submit']))
{
 ...
 $pd=$su.sha1($_POST['pass']).$scu;
  ...
  $link=mysqli_connect("localhost","root","","live") or die("failed to connect database"); 
  $username =mysqli_real_escape_string($link,$username);
  $pd =mysqli_real_escape_string($link,$pd);

	$result=mysqli_query($link,"select * from reg where username='$username' and password='$pd'") or die("failed to query database".mysqli_error($link));
